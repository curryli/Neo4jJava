...
public class GroupBy_0701 {
	...
	public static void main(String[] args){
    	...
    	UtilQuery.CreateEdge("EdgeFile\\0701\\result2.csv", EdgeType4, EdgeProperty4);
    	
    	String EdgeType2 = "trans_region"; 
    	ArrayList<String> EdgeProperty2 = new ArrayList<String>();
    	EdgeProperty2.add("region");  //边的属性1
    	EdgeProperty2.add("amount");  //边的属性1
    	EdgeProperty2.add("hour");  //边的属性1
    	UtilQuery.CreateEdge("EdgeFile\\0701\\result.csv", EdgeType2, EdgeProperty2);
